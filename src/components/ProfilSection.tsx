    ...
    <div className="max-w-4xl mx-auto px-6">
      ...
      >
        <p className="text-smoke text-[14px] leading-[1.8] font-light">
          <strong className="text-steel font-medium">Data Scientist et Ingénieur IA</strong> en Master 2 Big Data & Data Strategy,
          ...
          d'un assistant IA en production. Orienté impact métier avec une capacité à transformer
